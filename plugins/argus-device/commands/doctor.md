...
3. **All green**: confirm in one line and tell the user you can drive the device now (screenshots, taps and typing all go through this plugin's `device_*` MCP tools).
